...
public class BeaconLineGraph extends BeaconGraph {
    ...
    public BeaconLineGraph(Context context) {
        super(context);
    }

    public BeaconLineGraph(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BeaconLineGraph(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BeaconLineGraph(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
