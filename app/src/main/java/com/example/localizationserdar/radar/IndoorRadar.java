...
import com.example.localizationserdar.mainmenu.LocationAnimator;
...
public class IndoorRadar extends IndoorView {
    ...
    public IndoorRadar(Context context) {
        super(context);
    }

    public IndoorRadar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public IndoorRadar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public IndoorRadar(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
