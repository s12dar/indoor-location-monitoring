...
public class IndoorMap extends IndoorView {
    ...
    protected IndoorMapBackground mapBackground;
    ...
    public IndoorMap(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public IndoorMap(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public IndoorMapBackground getMapBackground() {
        return mapBackground;
    }

    public void setMapBackground(IndoorMapBackground mapBackground) {
