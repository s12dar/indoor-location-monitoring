...
public class IndoorMapBackground {
    ...
    private IndoorMapBackground(Bitmap imageBitmap) {
    ...
    public static class Builder {
        ...
        private IndoorMapBackground beaconMapBackground;
        ...
        public static Builder from(@NonNull Bitmap imageBitmap) {
            ...
            builder.beaconMapBackground = new IndoorMapBackground(imageBitmap);
            return builder;
        }
        ...
        public IndoorMapBackground build() {
            // meters per pixel
