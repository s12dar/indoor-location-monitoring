...
public abstract class IndoorView extends View {
    ...
    public IndoorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void initialize() {
        ...
        primaryFillPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorAccent));
        ...
        secondaryFillPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorAccent));

        secondaryStrokePaint = new Paint(primaryStrokePaint);
        secondaryStrokePaint.setColor(ContextCompat.getColor(getContext(), R.color.colorAccent));
